...
// Removed session-based departmental filter for state admins to allow cross-dept oversight
if (!empty($_GET['dept_filter'])) {
    $filter['target_department'] = $_GET['dept_filter'];
}

$deptsCol = $db->getCollection('departments');
$allDepts = $deptsCol->distinct('name', ['state' => $_SESSION['state'] ?? '']);
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="header-left">
                    ...
                    <h1><i class="la la-list-alt"></i> Manage Complaints (<?php echo htmlspecialchars($_SESSION['state'] ?? 'State'); ?>)</h1>
                </div>
                <div class="user-info">
                ...
                <div class="card">
                    ...
                    <div class="toolbar" style="display:flex; justify-content:space-between; align-items:center; gap:1rem; flex-wrap:wrap;">
                        ...
                        <div style="display:flex; gap:0.5rem; align-items:center;">
                            <select id="dept_filter" class="filter-select" onchange="applyFilters()">
                                ...
                                <tr id="row-<?php echo $cId; ?>">
                                    ...
                                    <td>
                                        <div class="action-btns">
                                            ...
                                            <a href="../admin/generate_report.php?id=<?php echo $cId; ?>" target="_blank" class="btn btn-outline btn-sm" title="Download Report"><i class="la la-file-pdf-o"></i></a>
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            link.setAttribute("download", "ReportMyCity_State_Complaints_" + new Date().toISOString().slice(0,10) + ".csv");
