...
$deptOfficers = $fieldOfficersCol->find(['department' => $department, 'state' => $officerDoc['state'] ?? 'National']);
...
<body>
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="manage_oversight.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage_oversight.php' ? 'active' : ''; ?>" style="color:#ef4444;">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="header-left">
                    ...
                    <h1><span class="bordered-icon"><i class="la la-list-alt"></i></span> Dept. Complaints (<?php echo htmlspecialchars($department); ?>)</h1>
                </div>
                <div class="user-info">
            ...
            <div class="card">
                    <div class="card-header">
                        <h3><span class="bordered-icon"><i class="la la-list-alt"></i></span> Department Complaints (<?php echo count($complaintsList); ?>)</h3>
                    </div>
                                        ...
                                        <td>
                                            <div class="action-btns">
                                                <?php if (in_array($_SESSION['role'], ['senior_officer', 'district_admin', 'state_admin', 'national_admin'])): ?>
                                                    <button class="btn btn-info btn-sm" onclick="openUpdateModal('<?php echo $cId; ?>', '<?php echo htmlspecialchars($status); ?>', <?php echo htmlspecialchars(json_encode($c['officer_notes'] ?? '')); ?>)"><i class="la la-pencil-square-o"></i> Update/Assign</button>
                                                <?php endif; ?>
    ...
    <div class="modal-overlay" id="updateModal">
        <div class="modal" style="width: 100%; max-width: 600px; padding: 2.5rem; border-radius: var(--radius-lg);">
            <div class="modal-header" style="border-bottom: 2px solid var(--border); padding-bottom: 1rem; margin-bottom: 1.5rem;">
                <h3 style="font-size: 1.6rem; font-weight: 800; color: var(--gov-navy);"><span class="bordered-icon"><i class="la la-pencil-square-o"></i></span> Manage Complaint</h3>
    ...
    <div class="modal-overlay" id="viewModal">
        <div class="modal" style="width: 100%; max-width: 750px; padding: 2.5rem; border-radius: var(--radius-lg);">
            <div class="modal-header" style="border-bottom: 2px solid var(--border); padding-bottom: 1rem; margin-bottom: 1.5rem;">
                <h3 style="font-size: 1.6rem; font-weight: 800; color: var(--gov-navy);"><span class="bordered-icon"><i class="la la-list-alt"></i></span> Task & Issue Details</h3>
                <button class="modal-close" style="font-size: 1.8rem;">&times;</button>
            </div>
