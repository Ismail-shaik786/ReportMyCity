...
<head>
    ...
    <title>Department Head Console | ReportMyCity India</title>
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            <div class="page-header">
                    ...
                    <div>
                        <h1><span class="bordered-icon"><i class="la la-bar-chart-o"></i></span> Department Head Console (<?php echo htmlspecialchars($department); ?>)</h1>
            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    ...
                    <div class="profile-meta">
                        <span><span class="bordered-icon gold"><i class="la la-list-alt"></i></span> <?php echo $assignedTotal; ?> team tasks</span>
                        <span><span class="bordered-icon gold"><i class="la la-check-square-o"></i></span> <?php echo $assignedResolved; ?> resolved</span>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); margin-bottom: 2rem;">
                ...
                <div class="card" style="padding: 1.5rem; display: flex; flex-direction: column; align-items: center;">
                    <h3 style="margin-bottom: 1rem; font-size: 1rem; color: var(--text-primary);"><span class="bordered-icon"><i class="la la-line-chart"></i></span> Team Workflow</h3>
                ...
                <div class="card" style="padding: 1.5rem; display: flex; flex-direction: column; align-items: center;">
                    <h3 style="margin-bottom: 1rem; font-size: 1rem; color: var(--text-primary);"><span class="bordered-icon"><i class="la la-bar-chart-o"></i></span> Complaint Status</h3>
                    <div style="width: 100%; height: 220px;">
            ...
            <div class="card">
                <div class="card-header">
                    <h3><span class="bordered-icon"><i class="la la-list-alt"></i></span> Recent Departmental Activity</h3>
