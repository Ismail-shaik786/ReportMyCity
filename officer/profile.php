...
<div class="dashboard-layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="officer_dashboard.php"><span class="nav-icon"><i class="la la-bar-chart-o"></i></span> Dashboard</a>
            <a href="my_assignments.php"><span class="nav-icon"><i class="la la-list-alt"></i></span> My Assignments</a>
            <a href="profile.php" class="active"><span class="nav-icon"><i class="la la-user-o"></i></span> My Profile</a>
        </nav>
            ...
            <div class="profile-wrapper">
                ...
                <aside class="profile-sidebar-card">
                    <div class="profile-avatar-container">
                        ...
                        <label for="photo-input" class="avatar-edit-btn" title="Change Photo"><i class="la la-picture-o"></i></label>
                        <input type="file" id="photo-input" accept="image/*">
                    </div>
                    <div class="profile-info-lite">
                        <h2 id="sidebar-display-name"><?php echo htmlspecialchars($userName); ?></h2>
                        <p><?php echo htmlspecialchars($userEmail); ?></p>
                        <div class="account-badge"><i class="la la-shield"></i> Field Officer</div>
                    </div>
